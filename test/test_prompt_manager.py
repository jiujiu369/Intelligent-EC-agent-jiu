...
failures += _assert("无权修改商品" in consumer_prompt and "查看销售报表" in consumer_prompt, "消费者角色约束被拼接")
...
failures += _assert("普通买家" in get_role_description(ROLE_CONSUMER), "可单独获取消费者角色描述")
